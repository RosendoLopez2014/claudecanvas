...
const CANVAS_CLAUDE_MD = [
  ...
  '',
  '1. Formulate your implementation plan.',
  '2. **CALL `critic_review_plan`** with the full plan text. Do NOT skip this step. Do NOT write files, call Edit, Write, Bash, or canvas_render before the critic responds.',
  '3. Wait for the critic verdict. Write/execute tools are BLOCKED until the critic approves.',
  '',
